...
import com.team.cobi.sales.dto.SalesEstimateCreateRequest;
import com.team.cobi.sales.dto.SalesEstimateUpdateRequest;
...
@NoArgsConstructor
@AllArgsConstructor
public class SalesEstimate extends BaseEntity implements Serializable {
    ...
    public SalesEstimate(SalesEstimateCreateRequest request) {
    ...
    public void update(SalesEstimateUpdateRequest request) {
        this.productId = request.getProductId();
        this.productQuantity = request.getProductQuantity();
        this.unitPrice = request.getUnitPrice();
        this.supplyValue = request.getSupplyValue();
