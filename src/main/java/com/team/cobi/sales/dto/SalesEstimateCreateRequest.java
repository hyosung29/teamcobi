...
@Data
public class SalesEstimateCreateRequest {
    @ApiModelProperty(name = "상품ID", position = 1)
    ...
    @ApiModelProperty(name = "창고명", position = 10)
    private String warehouseId;

    @ApiModelProperty(name = "섹션명", position = 11)
    private String sectionId;

    @ApiModelProperty(name = "재고ID", position = 12)
